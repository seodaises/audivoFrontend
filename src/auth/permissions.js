...
export const ROLES = {
  super_admin: { key: 'super_admin', label: 'Super Admin', level: 5,
    permissions: [P.DELETE_SONGS, P.MANAGE_USERS, P.VIEW_ANALYTICS, P.FEATURE_SONGS, P.MODERATE_COMMENTS, P.MANAGE_ROLES, P.MANAGE_CATALOG] },
  admin: { key: 'admin', label: 'Admin', level: 4,
    permissions: [P.DELETE_SONGS, P.MANAGE_USERS, P.VIEW_ANALYTICS, P.FEATURE_SONGS, P.MODERATE_COMMENTS, P.MANAGE_CATALOG] },
