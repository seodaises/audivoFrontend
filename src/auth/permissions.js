...
export const ROLES = {
  super_admin: { key: 'super_admin', label: 'Super Admin', level: 5,
    permissions: [P.DELETE_SONGS, P.MANAGE_USERS, P.VIEW_ANALYTICS, P.FEATURE_SONGS, P.MODERATE_COMMENTS, P.DELETE_COMMENTS, P.MANAGE_ROLES, P.MANAGE_CATALOG] },
  ...
  artist: { key: 'artist', label: 'Artist', level: 2, 
    permissions: [P.UPLOAD_SONGS, P.DELETE_SONGS, P.VIEW_ANALYTICS, P.FEATURE_SONGS, P.DELETE_COMMENTS] }, 
